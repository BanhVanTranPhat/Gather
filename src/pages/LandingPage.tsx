...
const LandingPage: React.FC<LandingPageProps> = ({ onJoin }) => {
  ...
  return (
    ...
    <div className="min-h-screen font-sans text-slate-900 dark:text-gray-100 bg-white dark:bg-gray-900 selection:bg-indigo-100 dark:selection:bg-indigo-900 selection:text-indigo-900 dark:selection:text-indigo-100 transition-colors duration-300">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:z-100 focus:p-4 focus:bg-white focus:text-indigo-600 top-4 left-4"
      >
        Skip to content
      </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="shrink-0 flex items-center gap-2 cursor-pointer">
              <div className="w-8 h-8 bg-linear-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center text-white font-bold text-xl">
                G
              </div>
            ...
            <nav className="hidden md:flex space-x-8">
              {NAV_ITEMS.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                  className="text-sm font-medium text-slate-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600 rounded-md px-2 py-1"
                >
                  {item.label}
                </a>
              ))}
            ...
            <div className="px-4 pt-2 pb-3 space-y-1">
              {NAV_ITEMS.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                  className="block px-3 py-2 rounded-md text-base font-medium text-slate-700 dark:text-gray-200 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-gray-700"
                >
                  {item.label}
                </a>
              ))}
              <div className="mt-4 pt-4 border-t border-slate-100 dark:border-gray-700 flex flex-col gap-2">
                ...
                <button
                  onClick={onJoin}
                  className="w-full text-center px-3 py-2 rounded-md text-base font-medium bg-indigo-600 text-white hover:bg-indigo-700"
                >
                  Tạo không gian
                </button>
              </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="flex-1 text-center lg:text-left z-10">
                ...
                <p className="text-lg sm:text-xl text-slate-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                  Cảm nhận sự hiện diện của đồng nghiệp. Đi lại gần để nói
                  chuyện ngay lập tức. Giảm thiểu những cuộc họp lên lịch cứng
                  nhắc và mệt mỏi.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <button
                    onClick={onJoin}
                    className="px-8 py-3.5 rounded-full bg-indigo-600 text-white font-semibold hover:bg-indigo-700 hover:-translate-y-0.5 transition-all shadow-xl shadow-indigo-200 dark:shadow-none focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-600 text-lg"
                  >
                    Tạo không gian
                  </button>
                  <button
                  ...
                  >
                    <span className="w-6 h-6 rounded-full bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center text-indigo-600 dark:text-indigo-300">
                      ▶
                    </span>
                    Xem demo
                  </button>
              ...
              <div className="flex-1 w-full max-w-xl lg:max-w-full relative">
                ...
                <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl dark:shadow-gray-900 border border-slate-100 dark:border-gray-700 overflow-hidden aspect-4/3 transform rotate-1 hover:rotate-0 transition-transform duration-500">
                  ...
                  <div className="absolute top-8 left-8 right-32 bottom-24 border-2 border-dashed border-indigo-200 dark:border-indigo-800 rounded-xl bg-indigo-50/50 dark:bg-indigo-900/20 flex items-center justify-center">
                    <span className="text-indigo-300 dark:text-indigo-500 font-bold text-2xl uppercase tracking-widest opacity-50 select-none">
                      Khu vực làm việc
                    </span>
                  </div>
                  ...
                  <div className="absolute top-1/3 left-1/4 flex flex-col items-center gap-1 animate-bounce-slow">
                    <div className="relative">
                      <div className="w-12 h-12 rounded-full bg-linear-to-r from-pink-400 to-rose-400 border-2 border-white dark:border-gray-800 shadow-md flex items-center justify-center text-white font-bold">
                        L
                      </div>
                      <div
                    ...
                    <span className="absolute -top-8 bg-white dark:bg-gray-700 border border-slate-200 dark:border-gray-600 text-slate-600 dark:text-gray-200 text-xs px-2 py-1 rounded-lg shadow-sm whitespace-nowrap animate-fade-in">
                      Review xong chưa?
                    </span>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center gap-16">
              <div className="flex-1 space-y-8">
                <div>
                  <h2 className="text-indigo-600 dark:text-indigo-400 font-semibold uppercase tracking-wide text-sm mb-2">
                    Phối hợp tức thì
                  </h2>
                  ...
                  <p className="text-slate-600 dark:text-gray-400 text-lg">
                    Không còn chờ đợi link Zoom. Thấy ai đó đang rảnh? Chỉ cần
                    di chuyển avatar của bạn lại gần họ để bắt đầu trò chuyện
                    ngay lập tức.
                  </p>
                </div>
                ...
                <button
                  onClick={onJoin}
                  className="text-indigo-600 dark:text-indigo-400 font-semibold hover:text-indigo-800 dark:hover:text-indigo-300 flex items-center gap-1 group"
                >
                  Dùng thử 30 ngày{" "}
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-16">
              <div className="flex-1 space-y-8">
                <div>
                  ...
                  <p className="text-slate-600 dark:text-gray-400 text-lg">
                    Cần tập trung? Bước vào khu vực "Focus Zone". Bạn vẫn hiện
                    diện với đồng nghiệp nhưng thông báo và âm thanh sẽ được tắt
                    tự động.
                  </p>
                </div>
        ...
        <section className="py-20 bg-indigo-900 dark:bg-gray-950 text-white transition-colors">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-indigo-200 dark:text-gray-400 max-w-2xl mx-auto">
              ...
              <div className="bg-indigo-800/50 dark:bg-gray-800/50 rounded-2xl p-8 border border-indigo-700/50 dark:border-gray-700/50">
                ...
                <ul className="space-y-4">
                  {COMPARISON_OLD.map((item, idx) => (
                    <li
                      key={idx}
                      className="flex items-start gap-3 text-indigo-100/80 dark:text-gray-400"
                    >
        ...
        <section className="py-24 bg-gradient-to-br from-indigo-600 to-purple-700 dark:from-indigo-900 dark:to-purple-900 text-white text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-indigo-100 dark:text-indigo-200 mb-10">
              Không cần thẻ tín dụng. Không phí thiết lập ẩn. Hủy bất cứ lúc
              nào.
            </p>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-12 text-indigo-100 dark:text-indigo-200 text-sm font-medium">
              <div className="flex items-center gap-2">
                <span className="w-6 h-6 rounded-full bg-white text-indigo-600 dark:text-indigo-900 flex items-center justify-center font-bold text-xs">
                  1
                </span>
            ...
            <button
              onClick={onJoin}
              className="bg-white text-indigo-700 dark:bg-indigo-500 dark:text-white text-lg font-bold px-10 py-4 rounded-full hover:bg-indigo-50 dark:hover:bg-indigo-400 transition-colors shadow-2xl focus:outline-none focus-visible:ring-4 focus-visible:ring-indigo-900 focus-visible:ring-offset-2"
            >
              Tạo không gian ngay
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1">
              <div className="flex items-center gap-2 text-white mb-4">
                <div className="w-6 h-6 bg-indigo-500 rounded flex items-center justify-center font-bold text-xs">
                  G
                </div>
